...
public class TSVUtils {
    private static final int CHROM_INDEX = 4;
    ...
    public static String getChrom(String line) {
        return extractColumnFromLine(line, CHROM_INDEX, DELIMINER1);
    }

    public static Long getPos(String line) {
        Long pos = null;
        try {
            pos = Long.valueOf(extractColumnFromLine(line, POS_INDEX, DELIMINER1));
        } catch (NumberFormatException e) {
            // NaN, ignore
            try {
                pos = Long.valueOf(extractColumnFromLine(line, POS_INDEX, DELIMINER2));
