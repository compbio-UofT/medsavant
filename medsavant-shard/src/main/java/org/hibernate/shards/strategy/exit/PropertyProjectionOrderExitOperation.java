...
public class PropertyProjectionOrderExitOperation implements ExitOperation {
    ...
    public PropertyProjectionOrderExitOperation(List<InMemoryOrderBy> orders) {
        for (InMemoryOrderBy order : orders) {
            // TODO(maulik) support Ignore case!
            Preconditions.checkState(order.toString().endsWith("asc") || order.toString().endsWith("desc"));
    ...
    public List<Object> apply(List<Object> results) {
        ...
        Comparator<Object> comparator = new Comparator<Object>() {
            ...
            public int compare(Object o1, Object o2) {
                ...
                int cmp = 0;
                // the object must be array object other wise we wont get to
                // this piece of code
