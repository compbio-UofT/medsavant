 ...
 */
public class GenomicVariantImpl2 implements GenomicVariant, Serializable {
    ...
    /*
     public GenomicVariantImpl2(String[] line, long start, long end, String ref, String alt, int altNumber, VariantType vt) throws Exception {//, String[] infoKeys, Class[] infoClasses) {
     dnaID = null;
    ...
    public GenomicVariant create(
        ...
        GenomicVariantImpl2 instance = new GenomicVariantImpl2();
        instance.dnaID = dnaID;
     ...
     */
    @Override
    public int compareTo(GenomicVariantImpl2 other) {
    ...
    private Float extractFloatFromInfo(String key, String customInfo) {
        ...
        return (Float) GenomicVariantImpl2.parse(Float.class, val);
    }
    ...
    private Integer extractIntegerFromInfo(String key, String customInfo) {
        String val = extractValueFromInfo(key, customInfo);
        return (Integer) GenomicVariantImpl2.parse(Integer.class, val);
    }
