...
class DarkNiceListColorScheme implements NiceListColorScheme {
    ...
    private final Color backgroundColor = new Color(19, 19, 19);
    private final Color selectedColor = backgroundColor;
    ...
    private final Color unselectedFontColor = new Color(61, 61, 61);
    private final Color borderColor = new Color(30, 30, 30);
