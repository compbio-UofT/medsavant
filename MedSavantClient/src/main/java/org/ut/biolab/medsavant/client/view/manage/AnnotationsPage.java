                        ...
                        SwingUtilities.invokeLater(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (!inUse) {
                                    ...
                                    DialogUtils.displayMessage("This annotation is being used by other projects and cannot be uninstalled.  Please remove this annotation from these projects first.");
                                }
                            }
                        });
                    }
