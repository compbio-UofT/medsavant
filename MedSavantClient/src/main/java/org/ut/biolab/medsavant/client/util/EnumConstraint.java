...
/**
 * A constraint that takes on one of several non-null values.  A value constrained
 * by an EnumConstraint cannot be missing (null, blank, or whitespace only), and null cannot be 
 * specified as one of the allowed values.
 * 
 * @author jim
 */
public class EnumConstraint extends CustomFieldConstraint{
    ...
    /**
     * 
     * @param allowedValues An array of Value/Label pairs.  The constraint is applied only on the value, the label
     * is optional and may be null.   e.g. String[][] allowedValues = {{"Red", null}, {"Gre", "Green"}, {"Blu", "Blue"}};
    ...
    /**
     * 
     * @return An array of values allowed by this constraint, with their corresponding labels.  i.e. {{Val, Label}, {Val, Label} ....}
     */
