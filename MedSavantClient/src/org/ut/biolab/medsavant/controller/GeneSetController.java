...
public class GeneSetController implements ReferenceListener {
    ...
    public List<Gene> getCurrentGeneSet() throws SQLException, SQLException, RemoteException {
        if (genes == null) {
            ...
            List<GeneSet> geneSetList =  MedSavantClient.GeneSetManager.getGeneSets(
                    session, ReferenceController.getInstance().getCurrentReferenceName());
            GeneSet geneSet =geneSetList.get(0);
