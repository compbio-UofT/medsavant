...
public class ProjectUtils {
    ...
    public static TableSchema getCustomVariantTableSchema(int projectID, int refID) throws SQLException, RemoteException {
        return MedSavantClient.CustomTablesManager.getCustomTableSchema(LoginController.sessionId,MedSavantClient.ProjectManager.getVariantTableName(LoginController.sessionId, projectID, refID, true));
    }
