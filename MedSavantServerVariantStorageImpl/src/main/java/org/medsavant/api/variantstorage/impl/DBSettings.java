...
public class DBSettings {
    ...
    public static String getVariantSubsetTableName(int projectId, int referenceId, int updateId) {
        return getVariantTableName(projectId, referenceId, updateId)+"_subset";
    }
    ...
    public static String getVariantFileIBTableName() {
        TableSchema table = DBSchemas.VariantFileIBTableSchema;
