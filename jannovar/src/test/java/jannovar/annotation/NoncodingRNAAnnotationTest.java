...
public class NoncodingRNAAnnotationTest implements Constants {
    ...
    @Test public void testUTR3VarByHand1() throws AnnotationException, JannovarException  {
	byte chr = 4;
	int pos = 20620683;
	String ref = "G";
	String alt = "A";
 ...
 *</P>
 */
@Test public void testIntronicVar11571() throws AnnotationException, JannovarException  {
	byte chr = 12;
	int pos = 48883012;
	String ref = "T";
	String alt = "C";
 ...
 *</P>
 */
@Test public void testNcRnaExonicVar33() throws AnnotationException, JannovarException  {
	byte chr = 1;
	int pos = 173429995;
	String ref = "G";
	String alt = "A";
 ...
 *</P>
 */
@Test public void testNcRnaExonicVar68() throws AnnotationException, JannovarException  {
	byte chr = 2;
	int pos = 90458648;
	String ref = "T";
	String alt = "-";
 ...
 *</P>
 */
@Test public void testNcRnaExonicVar155() throws AnnotationException, JannovarException  {
	byte chr = 5;
	int pos = 159912418;
	String ref = "C";
	String alt = "G";
 ...
 *</P>
 */
@Test public void testNcRnaExonicVar165() throws AnnotationException, JannovarException  {
	byte chr = 6;
	int pos = 31803065;
	String ref = "T";
	String alt = "-";
 ...
 *</P>
 */
@Test public void testNcRnaExonicVar281() throws AnnotationException, JannovarException  {
	byte chr = 9;
	int pos = 97329738;
	String ref = "-";
	String alt = "GA";
 ...
 *</P>
 */
@Test public void testNcRnaExonicVar399() throws AnnotationException, JannovarException  {
	byte chr = 14;
	int pos = 73079294;
	String ref = "-";
	String alt = "AA";
 ...
 *</P>
 */
@Test public void testNcRnaExonicVar518() throws AnnotationException, JannovarException  {
	byte chr = 17;
	int pos = 36353761;
	String ref = "C";
	String alt = "T";
 ...
 *</P>
 */
@Test public void testNcRnaExonicVar530() throws AnnotationException, JannovarException  {
	byte chr = 18;
	int pos = 19408950;
	String ref = "C";
	String alt = "T";
 ...
 *</P>
 */
@Test public void testNcRnaExonicVar560() throws AnnotationException, JannovarException  {
	byte chr = 20;
	int pos = 25829352;
	String ref = "T";
	String alt = "C";
 ...
 *</P>
 */
@Test public void testNcRnaExonicVar649() throws AnnotationException, JannovarException  {
 ...
 *</P>
 */
@Test public void testNcRnaExonicVar651() throws AnnotationException, JannovarException  {
 ...
 *</P>
 */
@Test public void testNcRnaExonicVar652() throws AnnotationException, JannovarException  {
	byte chr = Y_CHROMOSOME;
	int pos = 23749507;
	String ref = "G";
	String alt = "-";
