...
public class UTR5AnnotationTest implements Constants {
    ...
    @Test public void testUTR3VarByHand1() throws AnnotationException, JannovarException, JannovarException  {
	byte chr = 4;
	int pos = 20620683;
	String ref = "G";
	String alt = "A";
 ...
 *</P>
 */
@Test public void testNcRnaExonicVar392() throws AnnotationException, JannovarException  {
	byte chr = 13;
	int pos = 76445189;
	String ref = "A";
	String alt = "G";
 ...
 *</P>
 */
@Test public void testUTR5Var39() throws AnnotationException, JannovarException  {
	byte chr = 1;
	int pos = 150483840;
	String ref = "C";
	String alt = "T";
 ...
 *</P>
 */
@Test public void testUTR5Var83() throws AnnotationException, JannovarException  {
	byte chr = 1;
	int pos = 245318688;
	String ref = "C";
	String alt = "T";
 ...
 *</P>
 */
@Test public void testUTR5Var84() throws AnnotationException, JannovarException  {
	byte chr = 1;
	int pos = 248058879;
	String ref = "A";
	String alt = "T";
 ...
 *</P>
 */
@Test public void testUTR5Var94() throws AnnotationException, JannovarException  {
	byte chr = 2;
	int pos = 73899613;
	String ref = "T";
	String alt = "G";
 ...
 *</P>
 */
@Test public void testUTR5Var119() throws AnnotationException, JannovarException  {
	byte chr = 2;
	int pos = 237150166;
	String ref = "A";
	String alt = "C";
 ...
 *</P>
 */
@Test public void testUTR5Var248() throws AnnotationException, JannovarException  {
	byte chr = 6;
	int pos = 108093580;
	String ref = "C";
	String alt = "T";
 ...
 *</P>
 */
@Test public void testUTR5Var310() throws AnnotationException, JannovarException  {
	byte chr = 9;
	int pos = 33933705;
	String ref = "A";
	String alt = "G";
 ...
 *</P>
 */
@Test public void testUTR5Var318() throws AnnotationException, JannovarException  {
	byte chr = 9;
	int pos = 114521630;
	String ref = "A";
	String alt = "G";
 ...
 *</P>
 */
@Test public void testUTR5Var370() throws AnnotationException, JannovarException  {
	byte chr = 11;
	int pos = 65793878;
	String ref = "A";
	String alt = "-";
 ...
 *</P>
 */
@Test public void testUTR5Var392() throws AnnotationException, JannovarException  {
	byte chr = 12;
	int pos = 8377448;
	String ref = "T";
	String alt = "-";
 ...
 *</P>
 */
@Test public void testUTR5Var397() throws AnnotationException, JannovarException  {
	byte chr = 12;
	int pos = 49218812;
	String ref = "-";
	String alt = "T";
 ...
 * annovar: TUBA1B
 */
@Test public void testUTR5Var399() throws AnnotationException, JannovarException  {
	byte chr = 12;
	int pos = 49525089;
	String ref = "CT";
	String alt = "-";
 ...
 *</P>
 */
@Test public void testUTR5Var509() throws AnnotationException, JannovarException  {
	byte chr = 17;
	int pos = 4544983;
	String ref = "-";
	String alt = "AAG";
 ...
 *</P>
 */
@Test public void testUTR5Var536() throws AnnotationException, JannovarException  {
	byte chr = 17;
	int pos = 61565990;
	String ref = "G";
	String alt = "C";
 ...
 *</P>
 */
@Test public void testUTR5Var618() throws AnnotationException, JannovarException  {
	byte chr = 22;
	int pos = 26862153;
	String ref = "C";
	String alt = "A";
 ...
 *</P>
 */
@Test public void testUTR5Var627() throws AnnotationException, JannovarException  {
