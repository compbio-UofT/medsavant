...
public class IntervalTreeTest {
	...
	public List<Interval<String>> randomList() throws IntervalTreeException, JannovarException {
	...
	public List<Interval<String>> getIntervalList1() throws IntervalTreeException, JannovarException {
		List<Interval<String>> ilist = new ArrayList<Interval<String>>();
	...
	public List<Interval<String>> getIntervalList2() throws IntervalTreeException, JannovarException {
		List<Interval<String>> ilist = new ArrayList<Interval<String>>();
	...
	public List<Interval<String>> getIntervalList3() throws IntervalTreeException, JannovarException {
		List<Interval<String>> ilist = new ArrayList<Interval<String>>();
	...
	@Test
	public void testSearchPub1() throws IntervalTreeException , JannovarException{
	...
	@Test
	public void testSearchPub2() throws IntervalTreeException , JannovarException{
		IntervalTree<String> tree = new IntervalTree<String>(getIntervalList2());
	...
	@Test
	public void testSearchPub3() throws IntervalTreeException , JannovarException{
	...
	@Test
	public void testSearch1() throws IntervalTreeException , JannovarException{
	...
	@Test
	public void testSearch2a() throws IntervalTreeException, JannovarException {
		IntervalTree<String> tree = new IntervalTree<String>(getIntervalList1());
	...
	@Test
	public void testSearch2b() throws IntervalTreeException , JannovarException{
		IntervalTree<String> tree = new IntervalTree<String>(getIntervalList1());
	...
	@Test
	public void testSearch3a() throws IntervalTreeException , JannovarException{
		IntervalTree<String> tree = new IntervalTree<String>(getIntervalList1());
	 ...
	 */
	@Test
	public void testSearch3b() throws IntervalTreeException , JannovarException{
		IntervalTree<String> tree = new IntervalTree<String>(getIntervalList1());
		List<String> qy = tree.search(20, 20);
	...
	@Test
	public void testSearch3c() throws IntervalTreeException , JannovarException{
		IntervalTree<String> tree = new IntervalTree<String>(getIntervalList1());
		List<String> qy = tree.search(20, 20);
	...
	/** Tests not finding an interval but getting the right neighbor */
	@Test
	public void testSearch3d() throws IntervalTreeException , JannovarException{
		IntervalTree<String> tree = new IntervalTree<String>(getIntervalList1());
	...
	/** Tests not finding an interval but getting the right neighbor */
	@Test
	public void testSearch3e() throws IntervalTreeException , JannovarException{
		IntervalTree<String> tree = new IntervalTree<String>(getIntervalList1());
