 ...
 */
package org.medsavant.junk;

import org.medsavant.api.annotation.impl.AnnotationCursor;
...
import static org.medsavant.api.annotation.impl.AnnotationCursor.MAX_BASEPAIR_DISTANCE_IN_WINDOW;
...
public class BatchVariantAnnotator {
    ...
    private JobProgressMonitorImpl jobProgress;
     ...
     */
    public BatchVariantAnnotator(JobProgressMonitorImpl jobProgress, File inputFile, File outputFile, Annotation[] annotations, String sid) throws RemoteException, SQLException {
