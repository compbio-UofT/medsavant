...
public class ImportVariants {
    ...
    public static int performImport(String sid, File[] vcfFiles, File tmpDir, int projectId, int referenceId, JLabel progressLabel, String user) throws Exception {

        //add log
        int updateId = -1;
        try {
            updateId = AnnotationLogQueryUtil.getInstance().addAnnotationLogEntry(sid,projectId, referenceId, Action.ADD_VARIANTS, user);
        ...
        try {
            try {
                return performImportHelper(sid, updateId, tableName, vcfFiles, tmpDir, projectId, referenceId, progressLabel);
            } catch (SQLException e){
    ...
    private static int performImportHelper(String sid, int updateId, String tableName, File[] vcfFiles, File tmpDir, int projectId, int referenceId, JLabel progressLabel) throws SQLException, InterruptedException, FileNotFoundException, IOException, ParseException, Exception {
