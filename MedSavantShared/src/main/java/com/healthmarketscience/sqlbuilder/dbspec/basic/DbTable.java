...
public class DbTable extends DbObject<DbSchema> implements Table {
     ...
     * @param scale optional scale specification for the column
     * @return the freshly created column
     */
    public DbColumn addColumn(String name, String typeName, Integer typeLength, Integer scale) {
        DbColumn column = getSpec().createColumn(this, name, typeName, typeLength, scale);
        return addColumn(column);
    }
/*
    public DbColumn addColumn(String name, String typeName, Integer typeLength) {
        return addColumn(name, typeName, typeLength, 0);
    }
*/
    /**
     * Creates and adds an typed column with the given parameters to this table.
    ...
    public DbColumn addColumn(String name, int type, Integer typeLength, Integer scale) {
        return addColumn(name, DbColumn.getTypeName(type), typeLength, scale);
    }
