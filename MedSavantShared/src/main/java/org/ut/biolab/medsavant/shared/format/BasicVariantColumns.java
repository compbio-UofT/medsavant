...
/**
 * Interface which defines <code>CustomField</code> constants for the required
 * columns in every variant table. Used by both client and server.
 */
@Deprecated
public interface BasicVariantColumns {   
    ...
    //this ordering is an implementation detail, and shouldn't need to be exposed outside the variant storage engine.   
