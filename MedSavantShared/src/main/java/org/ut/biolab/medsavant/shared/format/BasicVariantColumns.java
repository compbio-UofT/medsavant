...
public interface BasicVariantColumns {
	...
	public static final CustomField JANNOVAR_EFFECT= new CustomField("EFFECT", ColumnType.VARCHAR, 1500, false, false, false, null, true, "Jannovar Effect", "Nature of the variant on a gene");
	public static final CustomField JANNOVAR_SYMBOL= new CustomField("HGVS", ColumnType.VARCHAR, 10000, false, false, false, null, false, "Jannovar Gene Symbol", "Specific genes and effects of this variant");
