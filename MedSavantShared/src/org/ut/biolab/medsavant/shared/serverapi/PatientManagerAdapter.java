...
public interface PatientManagerAdapter extends Remote {
    ...
    public CustomField[] getPatientFields(String sessID, int projectId) throws SQLException, RemoteException;
    public CustomField[] getCustomPatientFields(String sessID, int projectId) throws SQLException, RemoteException;
    public String getPatientTableName(String sessID, int projectId) throws SQLException, RemoteException;
    public void createPatientTable(String sessID, int projectid, CustomField[] fields) throws SQLException, ParserConfigurationException, SAXException, IOException, RemoteException;
